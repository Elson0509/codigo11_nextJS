import classes from './LoadingHouse.module.css'
import {Fragment, memo} from 'react';

const LoadingHouse = () => {
    return (
        <div className={classes.Loading_coin}>
            <div className={classes.Coin}></div>
            <svg className={classes.Coin_keep} 
                id="Layer_1" 
                x="0px" 
                y="0px" 
                viewBox="0 0 512 512" 
            ...
            <div className={classes.Loading_point}>
                <span></span>
                <span></span>
                <span></span>
            </div>
...
export default memo(LoadingHouse);